...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_H2O_10.xml $scriptdir/heu_water_10mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_10.xml $scriptdir/heu_water_10mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/heu_water_10mg/flux_1th_8cg_8el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/heu_water_10mg/clust_1th_8cg_8el_1urr.xml
#######################
rm *.~ *.pyc
