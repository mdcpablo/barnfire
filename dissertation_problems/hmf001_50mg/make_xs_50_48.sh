...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_50.xml $scriptdir/hmf001_50mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf001_50mg/flux_1th_48cg_48el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf001_50mg/clust_1th_48cg_48el_1urr.xml
#######################
rm *.~ *.pyc
