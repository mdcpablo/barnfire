...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_UnpolutedAir_200.xml $scriptdir/hmf019_200newfeds/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HEU19_200.xml $scriptdir/hmf019_200newfeds/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Carbon12_200.xml $scriptdir/hmf019_200newfeds/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf019_200newfeds/flux_1th_1cg_198el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf019_200newfeds/clust_1th_1cg_198el_1urr.xml
#######################
rm *.~ *.pyc
