...
cp $SCRATCH_BARN/xs/ace/xdata/*.90c $scriptdir/hmf085_3_10CE/.
cp xsdir $scriptdir/hmf085_3_10CE/xsdir_hmf085_3_10CE
...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_UnpolutedAir_10.xml $scriptdir/hmf085_3_10CE/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HEU85_10.xml $scriptdir/hmf085_3_10CE/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_SteelyKnife_10.xml $scriptdir/hmf085_3_10CE/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf085_3_10CE/flux_1th_8cg_8el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf085_3_10CE/clust_1th_8cg_8el_1urr.xml
#######################
rm *.~ *.pyc
