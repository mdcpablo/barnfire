...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_5.xml $scriptdir/hmf001_5mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf001_5mg/flux_1th_3cg_3el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf001_5mg/clust_1th_3cg_3el_1urr.xml
#######################
rm *.~ *.pyc
