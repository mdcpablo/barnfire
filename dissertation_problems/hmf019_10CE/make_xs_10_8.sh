...
cp $SCRATCH_BARN/xs/ace/xdata/*.90c $scriptdir/hmf019_10CE/.
cp xsdir $scriptdir/hmf019_10CE/xsdir_hmf019_10CE
...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_UnpolutedAir_10.xml $scriptdir/hmf019_10CE/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HEU19_10.xml $scriptdir/hmf019_10CE/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Carbon12_10.xml $scriptdir/hmf019_10CE/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf019_10CE/flux_1th_8cg_8el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf019_10CE/clust_1th_8cg_8el_1urr.xml
#######################
rm *.~ *.pyc
