...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Graphite019_300.xml $scriptdir/hmf019_300mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HEU019_300.xml $scriptdir/hmf019_300mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf019_300mg/flux_1th_298cg_298el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf019_300mg/clust_1th_298cg_298el_1urr.xml
#######################
rm *.~ *.pyc
