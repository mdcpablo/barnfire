...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_200.xml $scriptdir/hmf001_200oldfeds_5EperCG/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf001_200oldfeds_5EperCG/flux_1th_39cg_198el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf001_200oldfeds_5EperCG/clust_1th_39cg_198el_1urr.xml
#######################
rm *.~ *.pyc
