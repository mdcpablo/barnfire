...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_UnpolutedAir_400.xml $scriptdir/hmf085_3_400oldfeds_5EperCG/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HEU85_400.xml $scriptdir/hmf085_3_400oldfeds_5EperCG/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_SteelyKnife_400.xml $scriptdir/hmf085_3_400oldfeds_5EperCG/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf085_3_400oldfeds_5EperCG/flux_1th_79cg_398el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf085_3_400oldfeds_5EperCG/clust_1th_79cg_398el_1urr.xml
#######################
rm *.~ *.pyc
