...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Pure_U235_500.xml $scriptdir/AlAgAu_500mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Al_500.xml $scriptdir/AlAgAu_500mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Ag_500.xml $scriptdir/AlAgAu_500mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Au_500.xml $scriptdir/AlAgAu_500mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/AlAgAu_500mg/flux_1th_498cg_498el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/AlAgAu_500mg/clust_1th_498cg_498el_1urr.xml
#######################
rm *.~ *.pyc
