...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Pure_U235_200.xml $scriptdir/AlAgAu_200feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Al_200.xml $scriptdir/AlAgAu_200feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Ag_200.xml $scriptdir/AlAgAu_200feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Au_200.xml $scriptdir/AlAgAu_200feds_new/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/AlAgAu_200feds_new/flux_1th_1cg_198el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/AlAgAu_200feds_new/clust_1th_1cg_198el_1urr.xml
#######################
rm *.~ *.pyc
