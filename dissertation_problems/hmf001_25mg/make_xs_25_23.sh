...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_25.xml $scriptdir/hmf001_25mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf001_25mg/flux_1th_23cg_23el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf001_25mg/clust_1th_23cg_23el_1urr.xml
#######################
rm *.~ *.pyc
