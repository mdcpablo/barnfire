...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_UnpolutedAir_600.xml $scriptdir/hmf085_3_600newfeds/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HEU85_600.xml $scriptdir/hmf085_3_600newfeds/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_SteelyKnife_600.xml $scriptdir/hmf085_3_600newfeds/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf085_3_600newfeds/flux_1th_1cg_598el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf085_3_600newfeds/clust_1th_1cg_598el_1urr.xml
#######################
rm *.~ *.pyc
