...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_H2O_250.xml $scriptdir/heu_water_250mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_250.xml $scriptdir/heu_water_250mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/heu_water_250mg/flux_1th_248cg_248el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/heu_water_250mg/clust_1th_248cg_248el_1urr.xml
#######################
rm *.~ *.pyc
