...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_600.xml $scriptdir/hmf001_600oldfeds_5EperCG/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf001_600oldfeds_5EperCG/flux_1th_119cg_598el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf001_600oldfeds_5EperCG/clust_1th_119cg_598el_1urr.xml
#######################
rm *.~ *.pyc
