...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_UnpolutedAir_400.xml $scriptdir/hmf019_400newfeds/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HEU19_400.xml $scriptdir/hmf019_400newfeds/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Carbon12_400.xml $scriptdir/hmf019_400newfeds/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf019_400newfeds/flux_1th_1cg_398el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf019_400newfeds/clust_1th_1cg_398el_1urr.xml
#######################
rm *.~ *.pyc
