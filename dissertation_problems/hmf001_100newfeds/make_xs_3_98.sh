...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_100.xml $scriptdir/hmf001_100newfeds/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf001_100newfeds/flux_1th_1cg_98el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf001_100newfeds/clust_1th_1cg_98el_1urr.xml
#######################
rm *.~ *.pyc
