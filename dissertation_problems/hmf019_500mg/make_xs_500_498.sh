...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Graphite019_500.xml $scriptdir/hmf019_500mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HEU019_500.xml $scriptdir/hmf019_500mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf019_500mg/flux_1th_498cg_498el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf019_500mg/clust_1th_498cg_498el_1urr.xml
#######################
rm *.~ *.pyc
