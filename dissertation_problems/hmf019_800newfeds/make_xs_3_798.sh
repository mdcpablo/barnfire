...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_UnpolutedAir_800.xml $scriptdir/hmf019_800newfeds/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HEU19_800.xml $scriptdir/hmf019_800newfeds/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Carbon12_800.xml $scriptdir/hmf019_800newfeds/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf019_800newfeds/flux_1th_1cg_798el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf019_800newfeds/clust_1th_1cg_798el_1urr.xml
#######################
rm *.~ *.pyc
