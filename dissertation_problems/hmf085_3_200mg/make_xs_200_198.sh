...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_UnpolutedAir_200.xml $scriptdir/hmf085_3_200mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HEU85_200.xml $scriptdir/hmf085_3_200mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_SteelyKnife_200.xml $scriptdir/hmf085_3_200mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf085_3_200mg/flux_1th_198cg_198el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf085_3_200mg/clust_1th_198cg_198el_1urr.xml
#######################
rm *.~ *.pyc
