...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Pure_U235_100.xml $scriptdir/AlAgAu_100feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Al_100.xml $scriptdir/AlAgAu_100feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Ag_100.xml $scriptdir/AlAgAu_100feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Au_100.xml $scriptdir/AlAgAu_100feds_new/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/AlAgAu_100feds_new/flux_1th_1cg_98el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/AlAgAu_100feds_new/clust_1th_1cg_98el_1urr.xml
#######################
rm *.~ *.pyc
