...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Pure_U235_400.xml $scriptdir/AlAgAu_400feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Al_400.xml $scriptdir/AlAgAu_400feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Ag_400.xml $scriptdir/AlAgAu_400feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Au_400.xml $scriptdir/AlAgAu_400feds_new/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/AlAgAu_400feds_new/flux_1th_1cg_398el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/AlAgAu_400feds_new/clust_1th_1cg_398el_1urr.xml
#######################
rm *.~ *.pyc
