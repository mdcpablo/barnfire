...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_500.xml $scriptdir/heu20_500mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/heu20_500mg/flux_1th_498cg_498el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/heu20_500mg/clust_1th_498cg_498el_1urr.xml
#######################
rm *.~ *.pyc
