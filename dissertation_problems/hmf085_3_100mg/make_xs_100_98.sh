...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_UnpolutedAir_100.xml $scriptdir/hmf085_3_100mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HEU85_100.xml $scriptdir/hmf085_3_100mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_SteelyKnife_100.xml $scriptdir/hmf085_3_100mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf085_3_100mg/flux_1th_98cg_98el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf085_3_100mg/clust_1th_98cg_98el_1urr.xml
#######################
rm *.~ *.pyc
