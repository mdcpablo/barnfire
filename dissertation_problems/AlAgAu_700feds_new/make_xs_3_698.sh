...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Pure_U235_700.xml $scriptdir/AlAgAu_700feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Al_700.xml $scriptdir/AlAgAu_700feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Ag_700.xml $scriptdir/AlAgAu_700feds_new/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Au_700.xml $scriptdir/AlAgAu_700feds_new/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/AlAgAu_700feds_new/flux_1th_1cg_698el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/AlAgAu_700feds_new/clust_1th_1cg_698el_1urr.xml
#######################
rm *.~ *.pyc
