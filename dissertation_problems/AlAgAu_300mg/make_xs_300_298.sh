...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Pure_U235_300.xml $scriptdir/AlAgAu_300mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Al_300.xml $scriptdir/AlAgAu_300mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Ag_300.xml $scriptdir/AlAgAu_300mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_Natural_Au_300.xml $scriptdir/AlAgAu_300mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/AlAgAu_300mg/flux_1th_298cg_298el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/AlAgAu_300mg/clust_1th_298cg_298el_1urr.xml
#######################
rm *.~ *.pyc
