...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_H2O_100.xml $scriptdir/heu_water_100mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_100.xml $scriptdir/heu_water_100mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/heu_water_100mg/flux_1th_98cg_98el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/heu_water_100mg/clust_1th_98cg_98el_1urr.xml
#######################
rm *.~ *.pyc
