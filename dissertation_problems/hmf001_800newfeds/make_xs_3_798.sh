...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_800.xml $scriptdir/hmf001_800newfeds/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/hmf001_800newfeds/flux_1th_1cg_798el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/hmf001_800newfeds/clust_1th_1cg_798el_1urr.xml
#######################
rm *.~ *.pyc
