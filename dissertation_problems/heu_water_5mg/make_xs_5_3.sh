...
c=(1.0000000000e-03 2.4101422642e+00 5.8087857336e+03 1.4000000000e+07 ) 
...
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_H2O_5.xml $scriptdir/heu_water_5mg/. 
cp $SCRATCH_BARN/xs/pdtxs/BarnfireXS_HMF001_5.xml $scriptdir/heu_water_5mg/. 
cp $SCRATCH_BARN/dat/indicators/flux.xml $scriptdir/heu_water_5mg/flux_1th_3cg_3el_1urr.xml 
cp $SCRATCH_BARN/dat/energy_groups/clust-$g-$res.xml $scriptdir/heu_water_5mg/clust_1th_3cg_3el_1urr.xml
#######################
rm *.~ *.pyc
