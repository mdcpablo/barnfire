...
def read_energy_and_indicators(dataDict):
    ...
    if materialOpt == 'c5g7':
        ...
        importanceDict = {'Pure_U235': 1} 
    elif materialOpt == 'HEU':
        importanceDict = {'HEU': 1} 
        # ------------------------------------
...
def define_input_parser():
    ...
    parser.add_argument('-m', '--materialopt', help="Unless 'manual' is used, specifies a set of materials to use. If 'manual' is used, give a space-separated list of material names in 'listmaterials'.", choices=['HEU','Pure_U235','4','5','c5g7', 'graphite', 'iron', 'kpin', 'kenrichedpin', 'kcladpin', 'kpin2d', 'kenrichedpin2d', 'kmoxpin2d', 'kmoxenrichedpin2d', 'CASL', 'manual'], default=defaults['materialopt'])
