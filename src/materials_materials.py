...
def get_materials_name2function_dict():
    return {
        # Call Generated By Python Script
        'SteelyKnife': get_SteelyKnife_material,
        'HEU85': get_HEU85_material,
        'UnpolutedAir': get_UnpolutedAir_material,
        'Carbon12': get_Carbon12_material,
        'HEU19': get_HEU19_material,
        'Graphite019': get_Graphite019_material,
        'HEU019': get_HEU019_material,
        'H2O': get_H2O_material,
        'HMF001': get_HMF001_material,
        'Pure_U235': get_Pure_U235_material,
        'Natural_Au': get_Natural_Au_material,
        'Natural_Ag': get_Natural_Ag_material,
        'Natural_Al': get_Natural_Al_material,
        'Natural_Iron': get_Natural_Iron_material,
        'HEU20': get_HEU20_material,
        'Godiva': get_Godiva_material,
...
###############################################################################
# Function Generated By Python Script
def get_SteelyKnife_material(): 
    # 2019-06-22 21:39:35.927386
    shortName = 'SteelyKnife' 
    longName = 'SteelyKnife' 
    massDensity = 7.1600 #g/cc 
    fuelRadius = 17.2689 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    cAtomFractionsDict = {0: 1.0} 
    siAtomFractionsDict = {28: 0.0324807207314, 29: 0.00164929205374, 30: 0.00108722549289} 
    feAtomFractionsDict = {56: 0.771885924128, 57: 0.0178262121894, 58: 0.00237234159387, 54: 0.049171406440399995} 
    elemAtomFracDict = {'C': 0.12352687736986, 'Si': 0.03521723827803, 'Fe': 0.8412558843516699}
    # 
    chordLength = calc_chord_length('sphere', fuelRadius)
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
    abundanceDict = lookup_natl_abundances(ZAList) 
    override_abundances(ZAList, abundanceDict, cAtomFractionsDict, 'C') 
...
def get_HEU85_material(): 
    # 2019-06-22 21:39:35.784986
    shortName = 'HEU85' 
    longName = 'HEU85' 
    massDensity = 18.3937 #g/cc 
    fuelRadius = 7.1089 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    uAtomFractionsDict = {234: 0.0102497847598, 235: 0.939561833645, 238: 0.0501883815956} 
    elemAtomFracDict = {'U': 1.0}
    # 
    chordLength = calc_chord_length('sphere', fuelRadius)
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
    abundanceDict = lookup_natl_abundances(ZAList) 
...
def get_UnpolutedAir_material(): 
    # 2019-06-09 19:56:06.437221
    shortName = 'UnpolutedAir' 
    longName = 'UnpolutedAir' 
    massDensity = 0.0013 #g/cc 
    fuelRadius = 0.0000 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    nAtomFractionsDict = {14: 1.0} 
    oAtomFractionsDict = {16: 1.0} 
    elemAtomFracDict = {'O': 0.22, 'N': 0.78}
    # 
    chordLength = 0
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
    abundanceDict = lookup_natl_abundances(ZAList) 
    override_abundances(ZAList, abundanceDict, nAtomFractionsDict, 'N') 
    override_abundances(ZAList, abundanceDict, oAtomFractionsDict, 'O') 
    # 
    material = Material( 
        shortName=shortName, longName=longName, 
        temperature=temperature, thermalOpt=thermalOpt, 
...
def get_Carbon12_material(): 
    # 2019-06-09 19:56:06.298955
    shortName = 'Carbon12' 
    longName = 'Carbon12' 
    massDensity = 1.5299 #g/cc 
    fuelRadius = 12.6000 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    cAtomFractionsDict = {0: 1.0} 
...
def get_HEU19_material(): 
    # 2019-06-09 19:56:06.113500
    shortName = 'HEU19' 
    longName = 'HEU19' 
    massDensity = 18.4802 #g/cc 
    fuelRadius = 9.1500 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    cAtomFractionsDict = {0: 1.0} 
    feAtomFractionsDict = {56: 0.000136306, 57: 3.14789e-06, 58: 4.18926e-07, 54: 8.68307e-06} 
    wAtomFractionsDict = {184: 0.3064, 186: 0.2843, 180: 0.0012, 182: 0.265, 183: 0.1431} 
    uAtomFractionsDict = {234: 0.010788, 235: 0.87139, 238: 0.09032085} 
    elemAtomFracDict = {'C': 0.0224652, 'U': 0.97249885, 'Fe': 0.0039430734859, 'W': 0.00109334235121}
    # 
    chordLength = calc_chord_length('sphere', fuelRadius)
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
    abundanceDict = lookup_natl_abundances(ZAList) 
    override_abundances(ZAList, abundanceDict, cAtomFractionsDict, 'C') 
    override_abundances(ZAList, abundanceDict, feAtomFractionsDict, 'Fe') 
    override_abundances(ZAList, abundanceDict, wAtomFractionsDict, 'W') 
    override_abundances(ZAList, abundanceDict, uAtomFractionsDict, 'U') 
    # 
    material = Material( 
        shortName=shortName, longName=longName, 
...
def get_Graphite019_material(): 
    # 2019-05-31 16:04:15.346868
    shortName = 'Graphite019' 
    longName = 'Graphite019' 
    massDensity = 2.7000 #g/cc 
    fuelRadius = 12.6000 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    cAtomFractionsDict = {0: 0.0010894} 
...
def get_HEU019_material(): 
    # 2019-05-31 16:04:15.123821
    shortName = 'HEU019' 
    longName = 'HEU019' 
    massDensity = 18.7400 #g/cc 
    fuelRadius = 0.0000 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    uAtomFractionsDict = {234: 0.00052315, 235: 0.042256, 238: 0.0043799} 
    cAtomFractionsDict = {0: 0.0010894} 
    feAtomFractionsDict = {56: 0.000175378, 57: 4.01541e-06, 58: 5.35388e-07, 54: 1.12814e-05} 
    wAtomFractionsDict = {184: 1.6277e-05, 182: 1.4008e-05, 183: 7.5711e-06} 
    elemAtomFracDict = {'C': 0.0010894, 'U': 0.0471591, 'Fe': 0.00019121, 'W': 5.30191e-05}
    # 
    chordLength = 0
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
    abundanceDict = lookup_natl_abundances(ZAList) 
...
def get_H2O_material(): 
    # 2018-12-12 17:57:15.066228
    shortName = 'H2O' 
    longName = 'H2O' 
    massDensity = 1.0000 #g/cc 
    fuelRadius = 0.0000 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    hAtomFractionsDict = {1: 1} 
    oAtomFractionsDict = {16: 1} 
    elemAtomFracDict = {'H': 2.0, 'O': 1.0}
    # 
    chordLength = 0
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
    abundanceDict = lookup_natl_abundances(ZAList) 
...
def get_HMF001_material(): 
    # 2018-12-02 20:36:21.918439
    shortName = 'HMF001' 
    longName = 'HMF001' 
    massDensity = 18.7400 #g/cc 
    fuelRadius = 8.7407 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    uAtomFractionsDict = {234: 0.00049184, 235: 0.044994, 238: 0.0024984} 
    elemAtomFracDict = {'U': 1.0}
    # 
    chordLength = calc_chord_length('sphere', fuelRadius)
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
...
def get_Pure_U235_material(): 
    # 2018-10-06 16:14:24.215452
    shortName = 'Pure_U235' 
    longName = 'Pure_U235' 
    massDensity = 18.3937 #g/cc 
    fuelRadius = 0.0000 #cm 
...
def get_Natural_Au_material(): 
    # 2018-10-06 16:14:23.530711
    shortName = 'Natural_Au' 
    longName = 'Natural_Au' 
    massDensity = 19.3200 #g/cc 
    fuelRadius = 0.0000 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    auAtomFractionsDict = {197: 1.0} 
    elemAtomFracDict = {'Au': 1.0}
    # 
    chordLength = 0
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
    abundanceDict = lookup_natl_abundances(ZAList) 
    override_abundances(ZAList, abundanceDict, auAtomFractionsDict, 'Au') 
    # 
    material = Material( 
        shortName=shortName, longName=longName, 
        temperature=temperature, thermalOpt=thermalOpt, 
...
def get_Natural_Ag_material(): 
    # 2018-10-06 16:14:22.875375
    shortName = 'Natural_Ag' 
    longName = 'Natural_Ag' 
    massDensity = 10.5000 #g/cc 
    fuelRadius = 0.0000 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    agAtomFractionsDict = {107: 0.51839, 109: 0.48161} 
    elemAtomFracDict = {'Ag': 1.0}
    # 
    chordLength = 0
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
    abundanceDict = lookup_natl_abundances(ZAList) 
...
def get_Natural_Al_material(): 
    # 2018-10-06 16:14:22.168617
    shortName = 'Natural_Al' 
    longName = 'Natural_Al' 
    massDensity = 2.7000 #g/cc 
    fuelRadius = 0.0000 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    alAtomFractionsDict = {27: 1.0} 
    elemAtomFracDict = {'Al': 1.0}
    # 
    chordLength = 0
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
    abundanceDict = lookup_natl_abundances(ZAList) 
    override_abundances(ZAList, abundanceDict, alAtomFractionsDict, 'Al') 
    # 
    material = Material( 
        shortName=shortName, longName=longName, 
        temperature=temperature, thermalOpt=thermalOpt, 
...
def get_Natural_Iron_material(): 
    # 2018-10-01 18:54:36.157237
    shortName = 'Natural_Iron' 
    longName = 'Natural_Iron' 
    massDensity = 7.8740 #g/cc 
    fuelRadius = 0.0000 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    feAtomFractionsDict = {56: 0.000136306, 57: 3.14789e-06, 58: 4.18926e-07, 54: 8.68307e-06} 
    elemAtomFracDict = {'Fe': 1.0}
    # 
    chordLength = 0
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
    abundanceDict = lookup_natl_abundances(ZAList) 
...
def get_HEU20_material(): 
    # 2018-07-28 02:26:17.947339
    shortName = 'HEU20' 
    longName = 'HEU20' 
    massDensity = 18.7400 #g/cc 
    fuelRadius = 0.0000 #cm 
    temperature = 293.6 #K 
    thermalOpt = 'none' 
    uAtomFractionsDict = {235: 0.2, 238: 0.8} 
    elemAtomFracDict = {'U': 1.0}
    # 
    chordLength = 0
    symDict, ZList, ZAList = get_all_isotopes(elemAtomFracDict) 
...
def get_Godiva_material(): 
    # 2018-07-22 18:14:02.366678
    shortName = 'Godiva' 
    longName = 'Godiva' 
    massDensity = 18.7400 #g/cc 
    fuelRadius = 8.7407 #cm 
